...
define('ember-app/controllers/i-i-s-test-project-seller-l', ['exports', 'ember-flexberry/controllers/list-form'], function (exports, _listForm) {
  'use strict';
...
define('ember-app/enums/i-i-s-test-project-t-role', ['exports', 'ember-flexberry-data/utils/enum-functions'], function (exports, _enumFunctions) {
  'use strict';
...
define('ember-app/locales/en/forms/i-i-s-test-project-seller-l', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-test-project-seller', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/forms/i-i-s-test-project-seller-l', 'ember-app/locales/en/models/i-i-s-test-project-seller'], function (exports, _translations, _iISTestProjectSellerL, _iISTestProjectSeller) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    models: {
      'i-i-s-test-project-seller': _iISTestProjectSeller.default
    },
    ...
    forms: {
      ...
      'i-i-s-test-project-seller-l': _iISTestProjectSellerL.default
    }
...
define('ember-app/locales/ru/forms/i-i-s-test-project-seller-l', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-test-project-seller', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/forms/i-i-s-test-project-seller-l', 'ember-app/locales/ru/models/i-i-s-test-project-seller'], function (exports, _translations, _iISTestProjectSellerL, _iISTestProjectSeller) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-test-project-seller', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  'use strict';
  ...
  var Model = exports.Model = Ember.Mixin.create({
    role: _emberData.default.attr('i-i-s-test-project-t-role'),
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('SellerE', 'i-i-s-test-project-seller', {
      role: (0, _attributes.attr)('Роль', { index: 0 }),
...
define('ember-app/mixins/regenerated/serializers/i-i-s-test-project-seller-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-test-project-seller', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/i-i-s-test-project-seller', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-test-project-seller'], function (exports, _emberCpValidations, _model, _iISTestProjectSeller) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISTestProjectSeller.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISTestProjectSeller.Model, Validations, {});

  (0, _iISTestProjectSeller.defineProjections)(Model);
...
define('ember-app/routes/i-i-s-test-project-seller-l', ['exports', 'ember-flexberry/routes/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @default 'SellerL'
    */
    modelProjection: 'SellerL',

    /**
      Name of model to be used as list's records types.
       @property modelName
      @type String
      @default 'i-i-s-test-project-seller'
    */
...
define('ember-app/serializers/i-i-s-test-project-seller-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-test-project-seller-offline', 'ember-app/serializers/application-offline'], function (exports, _iISTestProjectSellerOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISTestProjectSellerOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-test-project-seller', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-test-project-seller', 'ember-app/serializers/application'], function (exports, _iISTestProjectSeller, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISTestProjectSeller.Serializer, {
    /**
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        'i-i-s-test-project-seller': 'id,role,фИО'
      });
...
define('ember-app/transforms/i-i-s-test-project-t-role', ['exports', 'ember-flexberry-data/transforms/flexberry-enum', 'ember-app/enums/i-i-s-test-project-t-role'], function (exports, _flexberryEnum, _iISTestProjectTRole) {
  'use strict';
  ...
  exports.default = _flexberryEnum.default.extend({
    enum: _iISTestProjectTRole.default,
